 ...
 * @return {string} chopped string, or `null` if `num` > `tmpStr.length`
 * 
 * @usage 'testing'.chop(3); => 'test'
 * @usage 'testing'.chop(-4); => 'ing'
 */
const chop = (tmpStr, num) => {
    var absNum = Math.abs(num);
    var rtn = null;
    if (tmpStr.length - absNum > 0) {
        const start = ((num < 0) ? absNum : 0);
        const end = ((num > 0) ? (tmpStr.length - absNum) : tmpStr.length);
...
const addPrototypes = () => {
    ...
    if (typeof String.prototype.times != 'function')
        String.prototype.times = function (num) { return times.call(null, this, num); }

    if (typeof String.prototype.pad != 'function')
        String.prototype.pad = function (num, char) { return pad.call(null, this, num, char); }

    if (typeof String.prototype.chop != 'function')
        String.prototype.chop = function (num) { return chop.call(null, this, num); }
